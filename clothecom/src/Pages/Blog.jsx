...
export default function Blog() {
  const blogs = [
    {
      img: "https://img1.junaroad.com//assets/images/mobileNotif/img-1703503964040.jpg?crsl_pos=3",
    ...
    {
      img: "https://img1.junaroad.com//assets/images/mobileNotif/img-1708346698411.jpg?crsl_pos=3",
    ...
    {
      img: "https://img1.junaroad.com//assets/images/mobileNotif/img-1708930303049.jpg?crsl_pos=3",
    ...
    {
      img: "https://img1.junaroad.com//assets/images/mobileNotif/img-1705580304432.jpg?crsl_pos=3",
      ...
      <div className="container">
        {blogs.map((ele, i) => (
          <div className="post" key={i}>
            <img src={ele.img} alt="Post Image" />
            <h2>{ele.title}</h2>
            <p>{ele.disc}</p>
